...
class Depenses {
  ...
  factory Depenses.FromFirestore(DocumentSnapshot document) {
  ...
  factory Depenses.fromMap(Map<String, dynamic> map) {
    return Depenses(
      uid: map['uid'] ?? '',
  ...
  factory Depenses.fromJson(String source) =>
      Depenses.fromMap(json.decode(source));

  @override
  String toString() {
    return 'Depenses(uid: $uid, user_uid: $user_uid, created_at: $created_at, created_at_heure: $created_at_heure, description: $description, montant: $montant)';
  }
