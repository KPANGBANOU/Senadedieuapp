...
import 'package:senadedieu/interface/vente_des_credits.dart';
import 'package:senadedieu/models/budget_tranches.dart';
import 'package:senadedieu/models/credits.dart';

class StreamTrancheVentesCredits extends StatelessWidget {
  const StreamTrancheVentesCredits({super.key, required this.tranche_uid});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: VentesCredits(tranche_uid: tranche_uid),
    );
  }
}
