...
import 'package:senadedieu/interface/depot_effectue_non_paye.dart';
...
class StreamDepotEffectueNonPaye extends StatelessWidget {
  const StreamDepotEffectueNonPaye(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: DepotEffectueNonPaye(tranche_uid: tranche_uid),
    );
  }
}
