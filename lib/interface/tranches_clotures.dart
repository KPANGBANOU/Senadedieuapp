...
import 'package:senadedieu/interface/stream_tranche_cloture.dart';
import 'package:senadedieu/models/tranches.dart';

class TranchesCloturees extends StatelessWidget {
  const TranchesCloturees({
    super.key,
  });
                  ...
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => StreamTrancheCloture(
