...
import 'package:senadedieu/interface/stream_vente_a_credit_non_paye.dart';
import 'package:senadedieu/models/vente_a_credit.dart';
import '../provider/provider_search.dart';
import 'drawer_admin.dart';

class ListVenteACreditsNonPaye extends StatelessWidget {
  const ListVenteACreditsNonPaye({super.key, required this.tranche_uid});
                          ...
                          ? ListTile(
                              onTap: () {
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          StreamVenteACreditEffectueNonPaye(
