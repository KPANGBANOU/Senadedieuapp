...
import 'package:senadedieu/interface/stream_retrait_effectue.dart';
import 'package:senadedieu/models/retrait.dart';
import '../provider/provider_search.dart';
import 'drawer_admin.dart';

class ListRetraits extends StatelessWidget {
  const ListRetraits({super.key, required this.tranche_uid});
  final String tranche_uid;
  @override
  Widget build(BuildContext context) {
    final retraits = Provider.of<List<Retraits>>(context);
                      ...
                      ? ListTile(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => StreamRetraitEffectue(
                                    tranche_uid: tranche_uid,
                                    client_uid: vente.client_uid,
                                    retrait_uid: vente.uid,
