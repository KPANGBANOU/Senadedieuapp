...
import 'package:senadedieu/interface/approvisionnement_credits.dart';
import 'package:senadedieu/models/credits.dart';

class StreamTrancheApprovisionnementCredits extends StatelessWidget {
  const StreamTrancheApprovisionnementCredits(
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: ApprovisionnerListCredits(tranche_uid: tranche_uid),
    );
  }
}
