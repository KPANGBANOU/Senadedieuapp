...
import 'package:senadedieu/interface/vente_a_credit_paye.dart';
...
class StreamVenteACreditEffectuePaye extends StatelessWidget {
  const StreamVenteACreditEffectuePaye(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: VenteACreditEffectuePaye(tranche_uid: tranche_uid),
    );
  }
}
