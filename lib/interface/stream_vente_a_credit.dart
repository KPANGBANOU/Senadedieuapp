...
import 'package:senadedieu/interface/vente_a_credit_effectue.dart';
...
class StreamVenteACreditEffectue extends StatelessWidget {
  const StreamVenteACreditEffectue(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: VenteACreditEffectue(tranche_uid: tranche_uid),
    );
  }
}
