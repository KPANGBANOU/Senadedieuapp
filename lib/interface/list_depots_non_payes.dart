...
import 'package:senadedieu/interface/stream_depot_effectue_non_paye.dart';
import 'package:senadedieu/models/depot.dart';
import '../provider/provider_search.dart';
import 'drawer_admin.dart';

class ListDepotsEffectuesNonPayes extends StatelessWidget {
  const ListDepotsEffectuesNonPayes({super.key, required this.tranche_uid});
