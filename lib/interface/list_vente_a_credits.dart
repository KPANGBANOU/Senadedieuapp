...
import 'package:senadedieu/interface/stream_vente_a_credit.dart';
import 'package:senadedieu/models/vente_a_credit.dart';
import '../provider/provider_search.dart';
import 'drawer_admin.dart';

class ListVenteACredits extends StatelessWidget {
  const ListVenteACredits({super.key, required this.tranche_uid});
