...
import 'package:senadedieu/interface/stream_depot_effectue.dart';
import 'package:senadedieu/models/depot.dart';
import '../provider/provider_search.dart';
import 'drawer_admin.dart';

class ListDepotsEffectues extends StatelessWidget {
  const ListDepotsEffectues({super.key, required this.tranche_uid});
  final String tranche_uid;
  @override
  Widget build(BuildContext context) {
    final depots = Provider.of<List<Depots>>(context);
                  ...
                  return !affiche
                      ? ListTile(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => StreamDepotEffectue(
                          ...
                          leading: CircleAvatar(
                            backgroundColor: Colors.lightBlue.shade900,
                            child: Text(
                              vente.client_nom.substring(0, 2).toUpperCase(),
                      ...
                      : vente.credit_nom
                              ...
                              vente.client_nom
                                  .toLowerCase()
                                  .contains(value.toLowerCase()) ||
                              vente.numero_depot.contains(value)
                          ? ListTile(
                              onTap: () {
                                Navigator.push(
                                    context,
