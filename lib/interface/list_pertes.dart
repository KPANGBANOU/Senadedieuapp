...
import 'package:senadedieu/interface/stream_perte.dart';
...
class ListePerte extends StatefulWidget {
  ListePerte({super.key, required this.tranche_uid});
          ...
          content: SingleChildScrollView(
            child: ListBody(
              ...
              children: [
                ...
                Text(
                  "Estimation du montant de la perte",
                  style: GoogleFonts.alike(fontWeight: FontWeight.bold),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    final String statut_code = await function.AjouterPerte(
                        "",
                        tranche_uid,
                        user.uid,
                        description,
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        provider.affiche_true();
                        final String statut_code = await function.DeletePerte(
                            tranche_uid,
                            perte_uid,
                            credit_uid,
                            perte_montant,
