...
import 'package:senadedieu/interface/vente_a_credit_non_paye.dart';
...
class StreamVenteACreditEffectueNonPaye extends StatelessWidget {
  const StreamVenteACreditEffectueNonPaye(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        StreamProvider(
            create: (context) => context
                .read<ServiceDB>()
                .vente_a_credit(tranche_uid, vente_uid),
      ...
      child: VenteACreditEffectueNonPaye(tranche_uid: tranche_uid),
    );
  }
}
